...
<form class='flex items-center justify-center bg-grey-lighter' onSubmit={onSubmit}>
  ...
  <input type='submit' class="bg-gray-500 items-center hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-full"/>
